...
| 02 | Command Injection            | Web            | CWE-78  | `GET /logs?search=`                   | easy       | [card](challenges/README.md#challenge-02) | [sol](challenges/README.md#solution-02) |
| 03 | Uncontrolled Format String   | Memory         | CWE-134 | `X-Forwarded-For` header → log        | medium     | [card](challenges/README.md#challenge-03) | [sol](challenges/README.md#solution-03) |
...
| 05 | Predictable Session ID       | Crypto/Web     | CWE-330 | `Set-Cookie: SESSION_<hex>`           | medium     | [card](challenges/README.md#challenge-05) | [sol](challenges/README.md#solution-05) |
...
| 08 | Use-After-Free (LogSink)      | Memory         | CWE-416 | `/admin/logging`                       | hard       | [card](challenges/README.md#challenge-08) | [sol](challenges/README.md#solution-08) |
...
| 11 | Type Confusion                | Memory         | CWE-843 | `/admin/add_rule` + `/admin/update_rule` + `/cgi-bin/*` | hard | [card](challenges/README.md#challenge-11) | [sol](challenges/README.md#solution-11) |
